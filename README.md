...
make test             # run unit + security tests (345 passing · 0 failing · 61 integration/legacy-skipped)
...
pytest tests/unit tests/security -v  # 345 passing · 0 failing · 61 skipped (INTEGRATION=1 runs live tests)

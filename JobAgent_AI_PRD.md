# Product Requirements Document: CareerCraft AI
...
CareerCraft AI deploys a harness of specialized AI agents — each owning a specific part of the job search workflow — orchestrated by a supervisor agent. Users bring their own AI API keys (Claude, GPT, Gemini, Ollama, NVIDIA NIM), pay only for what they use, and retain full control over their data.
...
CareerCraft AI - PRD v1.0 - Confidential - May 2026

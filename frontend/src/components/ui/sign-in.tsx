      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            {infoMessage && (
              <div className="animate-element rounded-2xl border border-primary/30 bg-primary/10 p-3 text-sm text-primary">
                {infoMessage}
              </div>
            )}
            ...
            <p className="animate-element animate-delay-1100 text-center text-sm text-muted-foreground">
              {isSignUp ? "Already have an account?" : "New to CareerCraft?"}{" "}
              <button
                type="button"
